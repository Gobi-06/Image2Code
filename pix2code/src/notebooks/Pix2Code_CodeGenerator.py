...
gui_output_path = "/Users/abhjha8/Image2Code/pix2code/src/dataset/web/model_result_gui_test"
...
for f in os.listdir(input_path):
    if f.find(".png") != -1 and "2BE940B3-F4A4-428F-86C8-10CB885CD62E" in f:
...
output_folder_path = "/Users/abhjha8/Image2Code/pix2code/src/dataset/web/model_result_final_test/"
